class LogbookEntryUpdatedNotifier < Noticed::Base
  ...
  notification_methods do
    def message
      "#{required_params[:logbook_entry].pilot_in_command}'s #{required_params[:logbook_entry].date} logbook entry has been updated for their flight sim on the #{required_params[:logbook_entry].aircraft}}."
    end
